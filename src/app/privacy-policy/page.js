 ...
 * This is a static page displaying the company's privacy policy information.
 */
  ...
  return (
    ...
    <div className="container mx-auto max-w-4xl p-8">
      ...
      <div className="prose max-w-none text-gray-700">
        ...
        <h2 className="text-orange-600">1. Information We Collect</h2>
        <p>
        ...
        <h2 className="text-orange-600">2. How We Use Your Information</h2>
        ...
        <h2 className="text-orange-600">3. Data Sharing</h2>
        <p>
        ...
        <h2 className="text-orange-600">4. Data Storage & Security</h2>
        <p>
        ...
        <h2 className="text-orange-600">5. Your Rights</h2>
        <p>
